<template>
	<view class="leftSider" :class="siderClasses">
		<view class="imgArr" :class="imgArrFrames">
			<image src="/static/images/mine/download.png" class="minImg" alt=""
				@click="toDownload('/pages/auction/download')">
				<view>
					<image src="/static/images/mine/aixin.png" class="minImg" alt="" @click="checkApp()">
				</view>
				<view class="people">
					<image src="/static/images/mine/p.png" class="pImg" alt=""
						@click="toMessage('/pages/auction/association')">
				</view>
				<image src="/static/images/mine/listener.png" class="minImg" alt="" @click="openSession()">
		</view>
		<image src="/static/images/new-index/addImg.png" class="newListImgDeg" v-if="imgShow" @click="toggleImage">
		</image>
