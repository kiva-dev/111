<template>
	<view class="invite-page">
      ...
      <view class="max-title2" style="font-size:36rpx;"> faster invite your friends to join now!</view> -->
		<!-- <view class="conter" style="margin-top:294px;padding-top: 2px;">
				<view class="title">
      ...
      <view class="max-title2">快邀请你的小伙伴行动吧</view> -->
		...
		<view class="zhezhao">
			<!-- 矩形 -->
			<canvas class="f__canvas" style="width:200px;height:100px" canvas-id="rectangleCanvas"
				id="rectangleCanvas"></canvas>
			<!-- 矩形+边框 -->
			<canvas class="f__canvas" style="width:200px;height:100px" canvas-id="rectangleBorderCanvas"
				id="rectangleBorderCanvas"></canvas>
			<!-- 头像 -->
			<canvas class="f__canvas" style="width:100px;height:100px" canvas-id="circularCanvas"
				id="circularCanvas"></canvas>
			<!-- 不变形图片-最短边显示完整 -->
			<canvas class="f__canvas" style="width:200px;height:200px" canvas-id="coverCanvas"
				id="coverCanvas"></canvas>
			<!-- 文本自定义换行超出省略 -->
			<canvas class="f__canvas" style="width:1000px;height:300px" canvas-id="textCanvas" id="textCanvas"></canvas>
			<!-- 英文换行不截断，居中显示 -->
			<canvas class="f__canvas" style="width:1000px;height:300px" canvas-id="textCanvas2"
				id="textCanvas2"></canvas>
			<!-- 按钮 -->
			<canvas class="f__canvas" style="width:260px;height:100px" canvas-id="buttonCanvas"
				id="buttonCanvas"></canvas>
			<!-- 海报 -->
			<canvas class="f__canvas" style="width:600px;height:730px" canvas-id="firstCanvas"
...
<script>
	...
	export default {
		...
		onShow() {
			...
			this.goodsTitle2 = uni.getStorageSync('locale') == 'en' ? 'faster invite your friends to join now!' :
				'快邀请你的小伙伴行动吧'
			...
			async createGoodsPoster() {
				...
				if (logo.path) {
					...
					if (this.isShopCont) {
						...
						ctx.fillText(this.title, 150, 350);
					}
					// 邀请码
...
<style lang="less" scoped>
	...
	.share-header{
		...
		border-radius: 16rpx;
		box-shadow: 0rpx 4rpx 10rpx rgba(255, 198, 188, 0.3);
