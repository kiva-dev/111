  ...
  <view class="gain-page">
    ...
    <view class="gain-box">
      ...
      <view class="att-goods" v-if="GoodsList.length">
        <navigator :url="'./detail?id='+item.goods_id" hover-class="none" class="goods" v-for="item in GoodsList" :key="item.goods_id">
          <view class="goods-con">
            ...
            <view class="goods-t" style=" height: 70rpx;">{{ item.goods_name }}</view>
            <view class="goods-m">
              <view class="price">
...
export default {
  data () {
    return {
      ...
      goods_type: 2,// 1普通商品，2团购商品，除团购模块都传1
      totalPageNum: 0,// 总条数
