<template>
  <view class="order-page">
    ...
    <view class="order-sec1">
      ...
      <view class="sec1-txt">
        <view class="sec1-h">河南省郑州市金水区</view>
        <view class="sec1-m">花园路36号国贸360A座206室</view>
        <view class="sec1-c">
          <text class="name">张三</text>
          <text class="phone">177****6722</text>
        </view>
      </view>
    </view>
    <!--order-sec1 end-->
      ...
      <view class="order-li">
        <view class="li-hd">
          <view class="hd-fl">
            ...
            <view class="name">卡西欧官方旗舰店</view>
          </view>
        </view>
        <!--order-mid start-->
        <view class="order-mid">
          <view class="mid-img">
            <image class="img" src="../../../static/images/auc7.png"></image>
          </view>
          <view class="mid-txt">
            <view class="h-flex">
              <view class="t">卡西欧手表男官方旗舰PRX8000光能电波海神户外登山男士运动表</view>

            </view>
            <view class="b-flex">
              <view class="s">蓝色，75-88mm</view>
              <view class="num">*1</view>
            </view>
            <view class="flex flex-between">
              <view class="price color-red f-22">
                RM<text class="f-34">868</text>.00
              </view>
              <button class="order-gray">申请售后</button>
            </view>
          </view>
        </view>
        <!--order-mid end-->
    ...
    <view class="order-sec3">
      <view class="sec3-li">
        ...
        <view class="price f-22">
          RM<text class="f-26">163</text>.00
        </view>
      </view>
      <!-- <view class="sec3-li">
				<view class="label">运费</view>
				<view class="price f-22">
					RM<text class="f-26">30</text>.00
				</view>
			</view> -->
      <view class="sec3-li">
        <view class="label">优惠券</view>
        <view class="price f-22 color-red">
          -RM<text class="f-26">10</text>.00
        </view>
      </view>
      <view class="sec3-bot">
        <view class="price">
          <text class="color-999 f-26">共1件</text>
          <text class="f-228">小计：</text>
          <text class="color-red f-22">RM<text class="f-28">153</text>.00</text>
        </view>
      </view>
    </view>
    <!--order-sec3 end-->
    ...
    <view class="order-sec4">
      ...
      <view class="sec4-li">
        ...
        <view class="c">14654654646555464</view>
      </view>
      <view class="sec4-li">
        <view class="label">支付方式:</view>
        <view class="c">余额支付</view>
      </view>
      <view class="sec4-li">
        <view class="flex">
          <view class="label">发货方式:</view>
          <view class="c">中通快递 545215455545</view>
        </view>
        <view class="copy-btn color-red f-26 m-l-40">复制</view>
      </view>
      <view class="sec4-li">
        <view class="label">创建时间：</view>
        <view class="c">2020-03-06 22:22:22</view>
      </view>
      <view class="sec4-li">
    ...
    <view class="order-fixed">
      <view class="fixed-con">
        <view class="fixed-fl color-red f-26">12:25:63后自动收货</view>
        <view class="fixed-fr">
          <button class="order-btn" @click="toggle1('center')">确认收货</button>
        </view>
      </view>
    </view>
    <!--order-fixed end-->
    ...
    <uni-popup ref="popup1">
      <view class="public-pop">
        <view class="pop-con">
          <view class="pop-c">
            <text class="f-32">确认已收到商品？</text>
          </view>
          <view class="pop-b">
            <button class="pop-btn" @click="toggle1Close">取消</button>
            <button class="pop-btn red" @click="toggle1Close">确认</button>
          </view>
        </view>
      </view>
    </uni-popup>
