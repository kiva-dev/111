		...
		<view class="sh-sec1">
			...
			<view class="order-li">
				<view class="li-hd">
					<view class="hd-fl">
						<view class="icon">
							<image class="img" :src="sangjiaCont.shop_logo"></image>
						</view>
				...
				<view class="order-mid">
					...
					<view class="mid-txt">
						...
						<view class="b-flex">
							...
							<view class="num">*{{shopCont.total_num || 1}}</view>
						</view>
						<view class="flex flex-between">
							<view class="price color-red f-22">
								RM<text
									class="f-34">{{$filter.formatValue(shopCont.pay_price, 'split')[0]}}</text>.{{$filter.formatValue(shopCont.pay_price, 'split')[1] ? $filter.formatValue(shopCont.pay_price, 'split')[1] : '00'}}
							</view>
						</view>
					</view>
				</view>
