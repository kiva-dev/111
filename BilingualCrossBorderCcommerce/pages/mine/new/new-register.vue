<template>
	<view class="rebate">
		...
		<image src="/static/images/new/jiarubaoxian.png" class="header" v-show="!isShopCont"></image>
		<image src="/static/images/new/jiarubaoxian-en.png" class="header" v-show="isShopCont"></image>
		...
		<view class="info">
			...
			<view class="info_tit">
				{{isShopCont ? 'Your friend' : '你的朋友'}} [ {{userCont.nickname}} ]
				{{isShopCont ? 'invites you to pick up the gift together!' : '邀请您一起领取礼物！'}}
			</view>
			...
			<view class="switch">
				<view class="switch_info" :class="select == 1 ? 'switch_select' : ''" @click="switchSelect(1)">
					...
					<image src="/static/demo/new_email.png" v-else></image>
				...
				<view class="switch_info" :class="select == 2 ? 'switch_select' : ''" @click="switchSelect(2)">
					...
					<image src="/static/demo/new_phone.png" v-else></image>
			...
			<view class="send_code">
				<view class="my-input" style="width: 500rpx;margin-top: 0;">
		...
		<view class="xy">
			<image src="/static/images/new-index/wxz.png" v-show="!isQuanShow" @click="isQuanShow=!isQuanShow">
			</image>
...
<style lang="less" scoped>
	.rebate {
		...
		.header {
			width: 750rpx;
			height: 760rpx;
			// background: url('/static/images/new/jiarubaoxian.png') no-repeat;
