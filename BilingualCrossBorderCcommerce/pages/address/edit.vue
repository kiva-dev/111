  ...
  <view class="add-page">
    <view class="add-box">
      ...
      <view class="add-li">
        ...
        <view class="switch">
          <switch color="rgb(10, 198, 142)" :checked="is_default?true:false" style="transform:scale(0.7);" @change="switchChange" />
        </view>
      </view>
      <!--add-bot start-->
      <view class="add-bot">
        ...
        <view class="li">
          <button class="public-btn" style="background: rgb(10, 198, 142);" @click.stop="$noMultipleClicks(onAddClick)">{{$t('user.address.baocun')}}</button>
        </view>
      </view>
      <!--add-bot end-->
      <!--退出账号弹出 start-->
